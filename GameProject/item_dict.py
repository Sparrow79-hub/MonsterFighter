...
ITEMS = {
    ...
    "Iron Greatsword": item2.item_id,# <melee object>
    "Wooden Bow": item3.item_id, #<ranged weapon>
    "Torch": item4.item_id,  # <Holdables object>
    "Health Potion": item5.item_id # <Consumables object>
